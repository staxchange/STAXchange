...
test("finance export UI does not directly mutate protected data", () => {
  const roots = [
    path.join(process.cwd(), "apps", "admin", "app", "billing", "simply-accounting-export"),
    path.join(process.cwd(), "apps", "admin", "components", "accounting-export")
  ];
